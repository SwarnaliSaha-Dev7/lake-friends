        ...
        <div class="col-12">
            <div class="member-list-part position-relative">
                <div class="d-flex align-items-center justify-content-between gap-2 mb-2 flex-wrap">
                    <h2 class="fs-5 common-heading mb-md-0 fw-semibold">Beverage Items List</h2>
                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addbeverageitem">+ Add Item</button>
                </div>
                <div class="table-responsive">
                    <table class="table rounded-3 overflow-hidden clubmemberlist2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            @forelse($beverageItemsList as $items)
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        @else
                                            <span class="d-inline-flex align-items-center justify-content-center rounded-circle bg-secondary text-white flex-shrink-0" style="width:40px;height:40px;font-size:16px;"><i class="fa-solid fa-bottle-water"></i></span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-nowrap">
                                        <button class="border-0 bg-light p-1 rounded-3 lh-1 action-btn editBeverageItem"
                                        ...
                                        @else
                                            <button class="border-0 bg-light p-1 rounded-3 lh-1 action-btn delete-beverage-row ms-1"
                                                data-id="{{ $items->id }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="9" class="text-center text-muted py-4">No beverage items found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
...
@section('modalComponent')
    ...
    {{-- Add Beverage Item Modal --}}
    <div class="modal fade" id="addbeverageitem" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title fs-5 fw-semibold">Add Beverage Item</h5>
                    <button type="button" class="btn-close bg-transparent fs-5 lh-1" data-bs-dismiss="modal" aria-label="Close">
                        <i class="fa-regular fa-circle-xmark"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="beverageItemForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-part mb-3">
                                    ...
                                    <select name="itemCat" id="add_itemCat" class="form-select py-2 shadow-none" required>
                                        ...
                                        @foreach($beverageCatList as $cat)
                            ...
                            <div class="col-lg-6">
                                <div class="form-part mb-3">
                                    ...
                                    <input type="number" name="size_ml" id="add_size_ml" class="form-control py-2 shadow-none" placeholder="e.g. 300" min="1" required>
                                    <div class="error-div text-danger small"></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-12">
                                <div class="text-end mod-footer">
                                    <button type="submit" class="btn btn-primary fw-semibold" id="beverageItem_submit">Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    {{-- Edit Beverage Item Modal --}}
    <div class="modal fade" id="editbeverageitem" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title fs-5 fw-semibold">Edit Beverage Item</h5>
                    <button type="button" class="btn-close bg-transparent fs-5 lh-1" data-bs-dismiss="modal" aria-label="Close">
                        <i class="fa-regular fa-circle-xmark"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="editBeverageItemForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-part mb-3">
                                    <label class="form-label"><small>Size (ml)</small></label>
                                    <input type="number" name="size_ml" id="edit_size_ml" class="form-control py-2 shadow-none" placeholder="e.g. 300" min="1" required>
                                    <div class="error-div text-danger small"></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-12">
                                <div class="text-end mod-footer">
                                    <button type="submit" class="btn btn-primary fw-semibold" id="editBeverageItem_submit">Update</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="col-12">
                            <div class="form-part mb-2 d-flex align-items-center gap-2">
                                ...
                                <button type="button" class="btn btn-info fw-semibold changePriceBtn"
                                    data-bs-toggle="modal" data-bs-target="#changebeverageprice">Change Price</button>
                            </div>
    ...
    {{-- Change Price Modal --}}
    <div class="modal fade" id="changebeverageprice" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title fs-5 fw-semibold">Change Beverage Price</h5>
                    <button type="button" class="btn-close bg-transparent fs-5 lh-1" data-bs-dismiss="modal" aria-label="Close">
                        <i class="fa-regular fa-circle-xmark"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="changeBeveragePriceForm">
                        <div class="mb-3">
                            <label class="form-label"><small>New Price</small></label>
                            <input type="number" name="newPrice" id="newBeveragePrice" class="form-control py-2 shadow-none"
    ...
    <div class="modal fade" id="deleteConfirmModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3">
                ...
                <input type="hidden" id="delete_beverage_id" value="">
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" id="confirmBeverageDeleteBtn">Yes, Delete</button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    // ── ADD form submit ──
    $('#beverageItemForm').on('submit', function (e) {
        e.preventDefault();
        ...
        var $btn = $('#beverageItem_submit');
        var origText = $btn.html();
        $btn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Processing...');

        var formData = new FormData($('#beverageItemForm')[0]);

        $.ajax({
            url: '{{ route("manage-beverage-items.store") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on('click', '.editBeverageItem', function () {
        var id = $(this).data('id');
        ...
        $.ajax({
            url: "{{ url('manage-beverage-items') }}/" + id + '/edit',
            type: 'GET',
            success: function (response) {
    ...
    // ── EDIT form submit ──
    $('#editBeverageItemForm').on('submit', function (e) {
        e.preventDefault();

        var id = $('#edit_item_id').val();
        var formData = new FormData(this);

        var $btn = $('#editBeverageItem_submit');
        var origText = $btn.html();
        $btn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Processing...');

        $.ajax({
            url: "{{ url('manage-beverage-items') }}/" + id,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#changeBeveragePriceForm').on('submit', function (e) {
        e.preventDefault();

        $.ajax({
            url: '{{ route("beverageItemPriceApproval.request") }}',
            type: 'POST',
            data: {
                item_id:   $('#price_item_id').val(),
                new_price: $('#newBeveragePrice').val(),
                _token:    '{{ csrf_token() }}'
            },
            success: function (response) {
                if (response.statusCode == 200) {
                    toastr.success(response.message);
                    $('#changebeverageprice').modal('hide');
                    setTimeout(function () { location.reload(); }, 1500);
                } else {
    ...
    // ── DELETE button click ──
    $('.delete-beverage-row').on('click', function (e) {
        e.preventDefault();
        ...
        $('#delete_beverage_id').val($(this).data('id'));
        $('#deleteConfirmModal').modal('show');
        return false;
    });

    // ── CONFIRM DELETE ──
    $('#confirmBeverageDeleteBtn').on('click', function () {
        var id  = $('#delete_beverage_id').val();
        var btn = $(this);
