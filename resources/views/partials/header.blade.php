                ...
                <div class="pt-3 pb-4 px-3 noti-body overflow-auto">
                    ...
                    @php
                        ...
                        $notiRoute = match(true) {
                            ...
                            in_array($nType, ['bar_transfer_pending','bar_stock_adjust_pending'])          => route('barStockApproval.list'),
                            in_array($nType, ['bar_transfer_done','bar_stock_adjusted'])                    => route('bar-stock.index'),
                            ...
                            in_array($nType, ['misc_item_create','misc_item_delete','misc_price_update','misc_item_update']) => route('miscApproval.list'),
