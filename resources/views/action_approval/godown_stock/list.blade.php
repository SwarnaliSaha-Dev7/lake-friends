            ...
            <div class="col-12">
                <div class="member-list-part my-xl-0 my-2 position-relative">
                    <div
                        ...
                        <h2 class="fs-5 common-heading mb-md-0 fw-semibold">Stock Approval List</h2>
                    </div>
                        ...
                        <table class="table rounded-3 overflow-hidden clubmemberlist2" cellspacing="0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-white fw-medium align-middle text-nowrap">Movement</th>
                                    <th class="text-white fw-medium align-middle text-nowrap">Direction</th>
                            ...
                            <tbody>
                                @foreach ($godownStockData as $data)
                                    @php
