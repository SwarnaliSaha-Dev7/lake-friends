        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-md-6">
                    <div class="form-part mb-3">
                        ...
                        <input type="number" name="minimum_amount" class="form-control py-2 shadow-none" placeholder="Minimum Spend Amount"  value="{{ old('minimum_amount', $minSpendRules->minimum_amount) }}" step="0.01" min="0" max="99999999" required>
                    </div>
            </div>
