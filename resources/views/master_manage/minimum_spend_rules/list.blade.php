                        ...
                        <table class="table rounded-3 overflow-hidden clubmemberlist2" cellspacing="0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-white fw-medium align-middle text-nowrap">Minimum Spend Amount</th>
                                    <th class="text-white fw-medium align-middle text-nowrap">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($minSpendRuleList as $spend_rules)
                                <tr>

                                    <!-- <td class="text-nowrap">{{ $loop->iteration }}</td> -->

                                    <td class="text-nowrap">{{ ucwords(str_replace('_', ' ', $spend_rules->minimum_amount)) }}</td>

                                    <!-- <td class="text-success text-nowrap">No</td> -->
                                    <td class="text-nowrap">

                                        <a href="{{ route('manage-minimum-spend-rules.edit', $spend_rules->id) }}" class="border-0 bg-light p-1 rounded-3 lh-1 action-btn" title="Edit">
                                            <small>
