...
@section('title', 'Edit Membership Duration Types Management')
            ...
            <div class="col-md-6">
                <div class="form-part mb-3">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" value="1" {{ old('is_lifetime', $membership_duration_types->is_lifetime) ? 'checked' : '' }} id="" name="is_lifetime">
