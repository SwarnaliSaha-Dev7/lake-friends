    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="member-list-part p-3">
                ...
                <form method="GET" action="{{ route('beverage-godown-stock.report') }}" id="reportFilterForm">
                    <div class="d-flex align-items-end gap-3 flex-wrap">
                        ...
                        <div>
                            ...
                            <a href="{{ route('beverage-godown-stock.report') }}" class="btn btn-outline-secondary ms-1">Today</a>
                        </div>
                        <div class="ms-auto">
                            <a href="{{ route('beverage-godown-stock.report.download', request()->only('from','to')) }}"
